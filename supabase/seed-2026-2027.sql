...
select s.id, v.* from s, (values
  ...
  ('formule_2', 'Formule 2 — Demi-journée (3h)', 'Matin ou après-midi', 'Tennis, padel ou pickleball, goûter et multi-activités. Du lundi au vendredi. Option déjeuner encadré disponible (35€ la semaine ou 8€ le jour). Prêt de raquettes inclus.', 170, true, true, false, 35, 'Matin : accueil 8h30-9h, activités 9h-12h • Après-midi : accueil 13h30-14h, activités 14h-16h30, départ 16h30-17h', 20),
