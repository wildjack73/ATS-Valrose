...
select s.id, v.* from s, (values
  ('formule_1', 'Formule 1 — Baby Tennis', 'À partir de 3 ans', '1h30 de tennis par jour, du lundi au vendredi. 2 créneaux possibles. Prêt de raquettes inclus.', 110, true, false, false, 0, 'Créneau matin 9h-10h30 ou après-midi 14h-15h30', 10),
  ('formule_2', 'Formule 2 — Demi-journée (3h)', 'Matin ou après-midi', 'Tennis, padel ou pickleball, goûter et multi-activités. Du lundi au vendredi. Option déjeuner encadré disponible (35€ la semaine ou 8€ le jour). Prêt de raquettes inclus.', 180, true, true, false, 35, 'Matin : accueil 8h30-9h, activités 9h-12h • Après-midi : accueil 13h30-14h, activités 14h-16h30, départ 16h30-17h', 20),
  ('formule_3', 'Formule 3 — Journée complète', '9h à 17h, au Club', 'Programme matin et après-midi : tennis, padel ou pickleball, goûter et multi-activités. Option déjeuner encadré disponible (35€ la semaine ou 8€ le jour). Prêt de raquettes inclus.', 280, false, true, false, 35, 'Accueil 8h30-9h • Matin 9h-12h • Déjeuner (option) • Après-midi 14h-16h30 • Départ 16h30-17h', 30),
  -- Note : prix_dejeuner_jour est défini séparément ci-dessous (8€)
  ('formule_4', 'Formule 4 — À la carte', 'Choisissez vos jours', 'Tarif selon les options choisies, jour par jour. Option déjeuner encadré disponible (35€ la semaine ou 8€ le jour). Idéal si vous n''êtes pas disponible toute la semaine. Prêt de raquettes inclus.', null, false, true, true, 35, 'Choix par jour (cf. tableau ci-dessous)', 40)
