...
select s.id, v.* from s, (values
  ...
  ('formule_4', 'Formule 4 — À la carte', 'Choisissez vos jours', 'Tarif selon les options choisies, jour par jour. Idéal si vous n''êtes pas disponible toute la semaine. Prêt de raquettes inclus.', null, false, false, true, 0, 'Choix par jour (cf. tableau ci-dessous)', 40)
